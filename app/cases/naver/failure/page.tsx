...
export default function NaverFailurePage() {
  return (
    <main className="relative min-h-screen bg-[#080c14]">
      <div className="pointer-events-none fixed inset-0">
        <div className="absolute -top-20 left-1/3 h-[500px] w-[500px] rounded-full bg-red-600/6 blur-[120px]" />
      </div>
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center justify-center px-6 py-40 text-center">
        ...
        <div className="mt-4 rounded-full border border-red-500/20 bg-red-500/10 px-3 py-0.5 text-xs font-bold text-red-400">
          🔴 네이버 SEO · 실패
        </div>
        <h1 className="mt-4 text-3xl font-bold text-white">준비 중</h1>
        <p className="mt-3 max-w-sm text-sm leading-relaxed text-gray-500">
          네이버 실패 케이스 콘텐츠를 정리 중입니다.<br />곧 업데이트됩니다.
        </p>
